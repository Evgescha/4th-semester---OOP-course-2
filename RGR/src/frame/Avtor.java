...
public class Avtor extends JDialog{
	...
	public Avtor() {
        ...
        foto = new JLabel(new ImageIcon(url)) ;
        	...
        	JOptionPane.showMessageDialog(this, "Не удается найти изображение автора, \n" 
        + "Пожалуйста, проверьте файлы программы");
        }
        
        // текст про автора
        jtxtArea.setEditable(false);
        jtxtArea.setText("Щербаков Александр Владимирович \n"
        			   + "28 вариант, площадь и обьем шара \n"
        			   + "Люблю: себя, не люблю: всех кроме себя");
